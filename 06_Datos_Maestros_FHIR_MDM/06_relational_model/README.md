...
`Transacciones_Encounter` conserva el monto original y expresa `monto_cobro`, `costo_meds` y `costo_total` en EUR. El tipo de cambio y los costos unitarios son parametros sinteticos configurables de `05_Scripts_MDM/mdm_config.py`.
